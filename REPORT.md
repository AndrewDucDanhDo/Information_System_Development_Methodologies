...
The system generates guidelines and a script to assist RMs with their customer service.
...
* Customers need a system that redirects their inquiries to a suitable RM so that they can have their queries answered.
...
## **7. Key Assumptions** ##
*	The budget to implement the new call management system is within the financial limit of the travel company.
* The timeline of the project is set for within two to three years.
*	The company has the resources to implement the new system
*	The company will continue to operate during the switch of new information system.
*	There exists already a supporting tool to create customer profiles exists (Profiler tool). 
...
* As a customer, I want to be served as soon as possible so that I am less likely to experience a long wait time.
...
* As a relationship manager,  I want a call management system that suitably matches my skills with a customer's query so that I can increase my chances of acheiving a sale.
* As a relationship manager I want a profiler tool that accurately asssesses my skills so that I can serve the end customer better.
